...
| `/root/.openclaw/workspace-public/AGENTS.md` | `templates/AGENTS-public.md` | server → repo | Public agent rules (create if missing) |
| `/root/.openclaw/openclaw.json` | `config/openclaw.json` | server → repo | Redact all secrets before writing |
| `/root/.openclaw/skills/*/SKILL.md` | `notes/skills.md` + `CONTEXT.md` | server → repo | Update skill tables, not raw file copy |
